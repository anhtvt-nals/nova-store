...
import { NamespaceProvider } from './provider/namespace.provider';
...
@Module({
  ...
  providers: [
    ...
    ProvisioningProcessor,
    {
      ...
      useFactory: (e2b: E2bProvider, runloop: RunloopProvider, blaxel: BlaxelProvider, github: GithubActionsProvider, namespace: NamespaceProvider) => {
      ...
      inject: [E2bProvider, RunloopProvider, BlaxelProvider, GithubActionsProvider, NamespaceProvider],
    },
  ],
