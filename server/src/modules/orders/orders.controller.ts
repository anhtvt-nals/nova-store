...
export class OrdersController {
  ...
  @Get('connections/export') exportConnections(@CurrentUser() user: AuthUser, @Query('proxyType') proxyType?: string) { return this.service.exportConnections(user.profileId, proxyType); }
