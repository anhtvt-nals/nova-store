...
export const translations = {
  en: {
    ...
    trialPlanName: 'Trial', trialPlanPrice: '50 credits', trialPlanDescription: 'A one-time trial for new accounts to test a clean SOCKS5 route.', trialPlanNodes: '1 node', trialPlanDuration: '1 day',
    proPlanName: 'Pro', proPlanPrice: 'Pay as you go', proPlanDescription: 'Flexible credit billing for teams that need more proxy capacity.', proPlanNodes: '5, 10, 15, or 20 nodes', proPlanDuration: '3, 7, 14, or 30 days',
  ...
  id: {
    ...
    trialPlanName: 'Trial', trialPlanPrice: '50 kredit', trialPlanDescription: 'Trial satu kali untuk akun baru yang ingin mencoba rute SOCKS5 bersih.', trialPlanNodes: '1 node', trialPlanDuration: '1 hari',
    proPlanName: 'Pro', proPlanPrice: 'Bayar sesuai pemakaian', proPlanDescription: 'Pembayaran kredit fleksibel untuk tim yang membutuhkan kapasitas proxy lebih besar.', proPlanNodes: '5, 10, 15, atau 20 node', proPlanDuration: '3, 7, 14, atau 30 hari',
