...
export const translations = {
  ...
  id: {
    ...
    catalog: 'katalog proxy', socksByCountry: 'SOCKS5 berdasarkan negara', catalogBody: 'Bandingkan negara dan buat pesanan langsung dari tabel.', country: 'Negara', proxyService: 'Layanan proxy', priceNode: 'Harga / node', nodes: 'Node', days: 'Hari', payment: 'Pembayaran', total: 'Total', action: 'Aksi', perDay: '/ hari', orderNow: 'Pesan sekarang', creating: 'Membuat…',
