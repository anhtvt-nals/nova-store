...
function StaticResidentialPage() {
  ...
  return <CustomerShell active="static"><main className="mx-auto max-w-7xl px-5 py-9 pb-28 lg:px-8 lg:py-12">
    <section className="relative overflow-hidden rounded-[2rem] bg-[#142037] px-6 py-8 text-white md:px-9"><div className="hero-grid absolute inset-0 opacity-20" /><div className="relative flex flex-col justify-between gap-5 md:flex-row md:items-end"><div><Link href="/client" className="mono text-[10px] uppercase tracking-[.18em] text-[#69d5d0] hover:text-white">{t('services')} / {t('clientNavStatic')}</Link><h1 className="mt-3 text-3xl font-extrabold tracking-[-.05em] md:text-4xl">{t('staticTitle')}</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300">{t('staticIntro')}</p></div><a href="#checkout" className="inline-flex min-h-10 items-center justify-center rounded-xl bg-[#f46c43] px-4 text-sm font-bold text-white hover:bg-[#df5934]">{t('orderFivePorts')} <ArrowRight className="ml-2" size={15} /></a></div></section>
