...
import type {
  AdminOrder, AdminProduct, CatalogProduct, Category, CreditWallet, GeneralSettings, PaginatedAdminOrders, Plan, ProductInput, ProxyNode, ProxyProvider, RuntimeProxyNode, SandboxKey, User, Order, ConnectionDetails, StaticResidentialOrder,
} from '@/lib/api-client';
